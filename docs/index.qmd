...
necessary_packages <- c("readstata13", "knitr", "tidyverse", "naniar", "writexl", "rcompanion", "performance","caret", "psych", "kableExtra", "stargazer")
...
# "r" Spearman correlation for continuous variable.
...
###### "r"\<-0.75 or "r"\>0.75: exelent predictor.

```{r echo=FALSE, fig.height=8.5, fig.width=8.5, warning=FALSE}
